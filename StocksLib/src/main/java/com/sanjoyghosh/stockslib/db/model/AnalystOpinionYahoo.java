...
@NamedQuery(name="findAnalystOpinionYahooByStockIdCreatedDate", query="SELECT aoy FROM AnalystOpinionYahoo aoy WHERE aoy.stockId = :stockId AND aoy.createdDate = :createdDate")
